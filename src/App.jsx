    ...
    return (
      <>
        <tr className=" bg-gray-800">
          ...
          <td className="px-6 py-4">Rp. {harga}</td>
      ...
      <div className="mt-10 px-5 py-5 ">
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col">
            ...
            <input type="text" name="nama" id="nama" className="h-10 border border-slate-600 rounded-lg my-2 px-5 text-lg" value={formData.nama} onChange={handleChange} />
          </div>
          ...
          <div className="flex flex-col">
            ...
            <input type="text" name="jumlah" id="jumlah" className="h-10 border border-slate-600 rounded-lg my-2 px-5 text-lg" value={formData.jumlah} onChange={handleChange} />
          </div>
          ...
          <div className="flex flex-col">
            ...
            <input type="number" name="harga" id="harga" className="h-10 border border-slate-600 rounded-lg my-2 px-5 text-lg" value={formData.harga} onChange={handleChange} />
          </div>
      ...
      <div className="px-2">
        <div className="relative overflow-x-auto">
          <table className="w-full text-sm text-left rtl:text-right text-gray-300 ">
            ...
            <tbody>
              {data.map((item, index) => {
                return <ListBelanjaan key={index} nama={item.nama} jumlah={item.jumlah} harga={item.harga} />
              })}
            </tbody>
            <tfoot>
              <tr className="font-semibold text-gray-300 bg-gray-700">
                ...
                <td className="px-6 py-3 text-center rounded-e-lg" colSpan={2}>Rp. 21,000</td>
              </tr>
            </tfoot>
          </table>
        </div>
